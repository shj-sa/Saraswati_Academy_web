const testimonials = [
  ...
  },
  {
    ...
    review: `Definitely recommend Saraswati Hindi Jagat. Hats off to Priyanka Ma’am who is working really hard to ensure kids get all the study materials on a daily/weekly basis. Teachers are well-trained. My daughter was with teacher Kumkum Jain. She's such a wonderful teacher who taught my child with full dedication and was always ready to help. She is very polite and humble, with immense patience with kids. My daughter has benefited a lot from their Hindi classes and is very happy with the teacher. She has gained immense confidence. They also provide lists of idioms, quotations, intros, and conclusions for each composition, which are so useful. Thanks to both Priyanka Ma’am and Kumkum Jain Ma’am for making my daughter’s PSLE Hindi journey less stressful, easier, and beneficial. ❤️🙏`,
  },
  {
    name: "Anil Kathe",
    profession: "Parent",
    imageSrc: "/Images/Testimonials/Telugu/anil-kathe.webp",
    review: `My daughter is reserved and doesn't open up easily. However, Akanksha Ma’am was able to crack this hard nut in just 4 months. Great teacher. Ma’am also did regular follow-ups and checks. Thank you!`,
  },
  {
    name: "Pooja Seth Pal",
    profession: "Parent",
    imageSrc: "/Images/Testimonials/Telugu/pooja-seth-pal.webp",
    review: `Very dedicated, diligent, and caring teachers. I highly recommend Saraswati Hindi Jagat for students looking to improve their writing and oral skills. The teachers truly care about their students’ progress.`,
  },
  {
    name: "Srinivas Davuluri",
    profession: "Parent",
    imageSrc: "/Images/Testimonials/Telugu/srinivas-davuluri.webp",
    review: `My daughter has been taking classes with Sarika Agarwal Ma’am since the beginning of this year, and we could see a lot of improvement in my kid's oral and writing skills. We highly recommend this institute!`,
  },
  {
    name: "Deepika Sharma",
    profession: "Parent",
    imageSrc: "/Images/Testimonials/Telugu/deepika-sharma.webp",
    review: `The teaching methods at Saraswati Hindi Jagat are just amazing! My son’s Hindi grades improved drastically after just a few months. The teachers are really patient, especially with younger kids, and make learning so much fun. I would highly recommend this center to anyone looking to strengthen their child's Hindi skills!`,
  },
  {
    name: "Manisha Sharma",
    profession: "Parent",
    imageSrc: "/Images/Testimonials/Telugu/manisha-sharma.webp",
    review: `I’ve seen my daughter transform her Hindi skills thanks to Saraswati Hindi Jagat. The teachers not only focus on the syllabus but also teach the children life skills through the language. This personalized approach has helped my daughter excel and develop a love for Hindi.`,
  },
  {
    name: "Nikhil Arora",
    profession: "Parent",
  ...
  },
  {
    ...
    review: `I'm extremely satisfied with the way Saraswati Hindi Jagat handles the language learning process. The teachers take time to understand each child’s learning pace and give individual attention. My daughter now enjoys learning Hindi and her grades have shown a marked improvement.`,
  },
  {
    name: "Renu Verma",
    profession: "Parent",
